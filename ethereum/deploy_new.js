...
const deploy = async () => {
  ...
  console.log("My interface is: ", compiledFactory.abi);
  console.log("My bytecode is: ", compiledFactory.evm.bytecode.object);
  const result = await new web3.eth.Contract(compiledFactory.abi)
    .deploy({ data: compiledFactory.evm.bytecode.object }) //the constructor does not need any arguments.
